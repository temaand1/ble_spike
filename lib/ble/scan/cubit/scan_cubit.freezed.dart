...
class _$ScanningImpl implements _Scanning {
  const _$ScanningImpl(final List<BleDevice> devices) : _devices = devices;
  ...
  @override
  String toString() {
    return 'ScanState.scanning(devices: $devices)';
  }
...
abstract class _Scanning implements ScanState {
  const factory _Scanning(final List<BleDevice> devices) = _$ScanningImpl;
